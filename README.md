...
1. What is the DOM?
   document object model, interface that treats document as a tree structure wherein each node is an object representing a part of the document.
2. What is an event?
   Signals/Actions that happen when a user interacts with the page
3. What is an event listener?
   They represent an object and waits for an event to occur.
